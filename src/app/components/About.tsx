  ...
  return (
    <section className="bg-white dark:bg-gray-900">
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            ...
            <div className="grid grid-cols-2 gap-4 mt-8 overflow-hidden">
                <Image className="mt-4 w-full lg:mt-20 rounded-lg lg:w-1/2" src="/images/heroseo/equipo.jpg" alt="office content 2" width={200}
                      height={300}/>
                <Image className="w-full rounded-lg lg:w-1/2" src="/images/heroseo/despa.jpg" alt="office content 1" width={200}
                      height={300} />
                <Image className="mt-4 w-full lg:mt-20 rounded-lg lg:w-1/2" src="/images/heroseo/equipo.jpg" alt="office content 2" width={200}
                      height={300}/>
                      <Image className="w-full rounded-lg lg:w-1/2" src="/images/heroseo/despa.jpg" alt="office content 1" width={200}
